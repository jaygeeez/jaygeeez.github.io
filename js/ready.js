function ready() {
    ...
    function animationFrame() {
        ...
        if(lives > 0 && gameStart === true) {
            ...
            if (mySquare.x <= 100 && myChar.y === mySquare.y || mySquare3.x <= 100 && myChar.y === mySquare3.y) {
                points = Math.floor(points + multiPoints);
                goodSound.play();
            }
            // If player hits red lose health
            if (mySquare2.x <= 100 && myChar.y === mySquare2.y || mySquare4.x <= 100 && myChar.y === mySquare4.y) {
                lives = lives - damage;
                badSound.play();
            }
            ...
            if (mySquare2.x <= -100 || mySquare2.x <= 45 && myChar.y === mySquare2.y) {
                mySquare2.x = 1080;
                mySquare2.y = newPosition();
            }
            if (mySquare3.x <= -100 || mySquare3.x <= 45 && myChar.y === mySquare3.y) {
                    mySquare3.x = 1080;
                    mySquare3.y = newPosition();
                    variation = 0;
            }
            if (mySquare4.x <= -100 || mySquare4.x <= 45 && myChar.y === mySquare4.y) {
                    mySquare4.x = 1080;
                    mySquare4.y = newPosition();
                    variation2 = 0;
            }
